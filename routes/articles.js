...
const articleModel = require('../db/areicleModel');
const fs = require('fs');
const path = require('path')
let router = express.Router();
var multiparty = require('multiparty')//处理文件上传
let articlesModel = require('../db/areicleModel');

/* 
 文章修改和新增接口
 请求方式：post请求
 入参：title content username id
返回值：从定向， 有id是修改业务 无id是新增业务，成功重定向，失败从定向write
